# Gowin TCL Build Script for MCR1 Arcade Core on Tang Console 60K
# Run headless from mcr1_console60k/ (see CLAUDE.md for the gw_sh invocation).
...
set_option -output_base_name mcr1_console60k
set_option -top_module mcr1_console60k_top
...
# Add source files
add_file src/mcr1_console60k_top.sv
...
add_file -type cst src/mcr1_console60k.cst
add_file -type sdc src/mcr1_console60k.sdc
